...
In this article, we discuss the idea of *signed mining* that tries to
provide a safe construct with high degrees of delibration. Signed
mining adds an additional requirement for mining hardware to hold the
private key of coinbase of mining rewards. In this way, botnets and
browser-based mining become much less efficient to carry out.
